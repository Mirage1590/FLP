...
urlpatterns = [
    ...
    path('admin_shoes/', views.shoe_list, name='shoe_list'),
    path('admin_shoes_add/', views.add_shoe, name='add_shoe'),
    path('admin_shoes_edit/<int:shoe_id>/', views.edit_shoe, name='edit_shoe'),
    path('admin_shoes_delete/<int:shoe_id>/', views.delete_shoe, name='delete_shoe'),
    path('stripe-webhook/', views.stripe_webhook, name='stripe-webhook'),
    path('order_confirmation/<int:order_id>/', views.order_confirmation, name='order_confirmation'),
    path("chat/<str:chat_box_name>/", views.chat_box, name="chat"),
    path('select_chat/', views.select_chat_view, name='select_chat'),
    path('chat_with_user/<int:user_id>/', views.chat_with_user_view, name='chat_with_user'),
    path('select_chat_admin/', views.select_chat_admin, name='select_chat_admin'),
    path('chat_with_admin/', views.chat_with_admin_view, name='chat_with_admin'),
